        ...
        <div class="container">
            <div class="filable_form_container">
                ...
                <div class="pagination_listing">
                    <ul>
                        <li><a href="http://10.0.11.22//assignment_4/category_list.php?page=1">first</a></li>
                        <?php   for ($i=1; $i<=$total_pages; $i++) {   ?>
                            <li><a href="http://10.0.11.22//assignment_4/category_list.php?page='.$i.'">".$i."</a></li>
                        <?php   };  ?>
                        <li><a href="http://10.0.11.22//assignment_4/category_list.php?page=$total_pages">Last</a></li>
                    </ul>
                </div>
